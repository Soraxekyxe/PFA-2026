...
public class HarassmentSweepDragFeedback : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    [Header("UI")]
    ...
    private Vector3 broomStartPosition;
    ...
    private void Awake()
    {
        broomStartPosition = broom.position;
    ...
    private void Update()
    {
        ...
        if (isDragging && !validated && harassmentFlowerTarget != null)
        {
            ...
            if (distance <= validationDistance)
            {
                ...
                broom.position = broomStartPosition;
                arrow.position = arrowStartPosition;

                healthHarrassment.ValidateHarassmentSweepDrag();
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        broom.position = eventData.position;
    }
