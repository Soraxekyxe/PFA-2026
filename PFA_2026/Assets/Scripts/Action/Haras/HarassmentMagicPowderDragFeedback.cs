...
public class HarassmentMagicPowderDragFeedback : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    [Header("UI")]
    ...
    private void Update()
    {
        ...
        if (isDragging && !validated && harassmentFlowerTarget != null)
        {
            ...
            if (distance <= validationDistance)
            {
                ...
                healthHarrassment.ValidateHarassmentMagicPowderDrag();
