...
public class HarassmentPrunerDragFeedback : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    private void Update()
    {
        ...
        if (isDragging && !validated && harassmentFlowerTarget != null)
        {
            ...
            if (distance <= validationDistance)
            {
                ...
                healthHarrassment.ValidateHarassmentPrunerDrag();
